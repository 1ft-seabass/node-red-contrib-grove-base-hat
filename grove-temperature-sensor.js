...
module.exports = function(RED) {
    function GroveTemperatureSensorNode(config) {
        ...
        node.on('input', function(msg) {
            ...
            exec('python -u ' + path.join( __dirname , 'grove-temperature-sensor.py') + ' ' + gpio_pin + ' ' + msg.payload, (err, stdout, stderr) => {
    ...
    RED.nodes.registerType("grove-temperature-sensor",GroveTemperatureSensorNode);
}
