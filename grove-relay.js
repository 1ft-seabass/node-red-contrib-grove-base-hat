...
module.exports = function(RED) {
    function GroveRelayNode(config) {
        ...
        node.on('input', function(msg) {
            ...
            exec('python -u ' + path.join( __dirname , 'grove-relay.py') + ' ' + gpio_pin + ' ' + msg.payload, (err, stdout, stderr) => {
    ...
    RED.nodes.registerType("grove-relay",GroveRelayNode);
}
