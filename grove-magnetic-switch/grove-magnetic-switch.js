...
module.exports = function(RED) {
    function GroveMagneticSwitch(config) {
        ...
        const grove_python = spawn('python', [ '-u' , path.join( __dirname , 'grove-magnetic-switch.py' ) , gpio_pin ]);
    ...
    RED.nodes.registerType("grove-magnetic-switch",GroveMagneticSwitch);
}
